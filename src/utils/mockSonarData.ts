...
export const INITIAL_TARGETS: SonarTarget[] = [
  ...
  },
  {
    ...
    rejectionReason: 'Calculated 3D height (0.09m) < 0.20m threshold. Multi-scale feature comparison revealed high highlight (82%) with near-zero shadow (12%) and normal seabed texture (18%). Classified as natural flat bedrock.',
    latitude: 9.183890,
    longitude: 79.125120,
    depthMeters: 34.0,
    pingIndex: 1188,
  ...
  },
  {
    ...
    fusedRiskScore: 6,
    status: 'REJECTED_FALSE_POSITIVE',
    rejectionReason: 'Zero acoustic shadow detected. Tri-feature fusion comparison rejected candidate: bedform texture without 3D acoustic relief.',
    latitude: 9.184850,
    longitude: 79.123910,
    depthMeters: 32.5,
    pingIndex: 1095,
