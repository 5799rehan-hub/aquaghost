    ...
    <div id="uploaded-image-analysis-studio" className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-mono text-slate-400">
                Acoustic Physics Denoising ➔ Multistage Feature Object Detection
              </span>
            </div>
            <h2 className="text-xl font-bold text-white tracking-tight">
              Sonar Swath Ingestion & 2-Stage Physics AI Engine
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2 border-t border-slate-800/80">
          {/* STAGE 1: Noise Filtering using Acoustic Physics */}
          <button
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] px-1.5 py-0.2 rounded bg-cyan-500/10 text-cyan-300 font-mono">
                  4-Phase Acoustic Denoising
                </span>
              </div>
              <h4 className="text-sm font-bold text-white mt-0.5">
                Filter Noise using Acoustic Physics & Multi-Stage Despeckling
              </h4>
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                TVG spreading equalization + Homomorphic log-domain separation + Bilateral filament preservation + Pythagorean SRGR unwarping.
              </p>
            </div>
          </button>

          {/* STAGE 2: Object Detection by Acoustic Physics & Multistage Features */}
          <button
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] px-1.5 py-0.2 rounded bg-purple-500/10 text-purple-300 font-mono">
                  GhostNetV2 + 3D Physics Gate
                </span>
              </div>
              <h4 className="text-sm font-bold text-white mt-0.5">
                Detect Object by Acoustic Physics & Multi-Stage Features
              </h4>
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                GhostNetV2/PANet multiscale heads + Tri-Head decomposition + 3D Acoustic shadow elevation solver + Flat rock rejection gate.
              </p>
            </div>
          </button>
        </div>
          ...
          {activeStage === 'stage1_denoising' ? (
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg text-xs font-mono">
              ...
              <div className="mt-3 p-2.5 rounded bg-slate-950/60 border border-slate-800/80 text-[11px] text-slate-300 leading-relaxed">
                <span className="text-cyan-400 font-bold">Acoustic Physics Formulae Applied:</span>
                <ul className="list-disc list-inside mt-1 space-y-0.5 text-slate-400">
                  ...
                  <li><strong className="text-slate-300">Homomorphic Transform:</strong> <code className="text-cyan-300">ln(I) = ln(Backscatter) + ln(Rayleigh_Noise)</code></li>
                  <li><strong className="text-slate-300">Slant-to-Ground Pythagorean:</strong> <code className="text-cyan-300">R_g = √(R_s² - H²)</code> for orthorectified seabed geometry.</li>
                </ul>
              </div>
            </div>
          ) : (
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg text-xs font-mono">
              <div className="flex items-center justify-between border-b border-slate-800 pb-2 mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-white text-sm">Stage 2: Multistage Feature AI & 3D Shadow Solver</h3>
                </div>
                <span className="text-[11px] text-purple-400 font-bold">GhostNetV2 + DFC Attention</span>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg text-xs font-mono">
            <div className="flex items-center justify-between border-b border-slate-800 pb-2 mb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-white text-sm">Acoustic Physics Parameters</h3>
              </div>
